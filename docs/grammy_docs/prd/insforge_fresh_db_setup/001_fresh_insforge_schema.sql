...
-- Date: 2026-03-03
-- Purpose:
--   - Rebuild the full app-facing database schema from scratch
--   - Preserve current bot/web contracts (tables, RLS, RPCs, realtime events)
-- =============================================================================
...
CREATE POLICY secrets_anon_update ON public.nezuko_secrets FOR UPDATE TO anon USING (TRUE) WITH CHECK (TRUE);
