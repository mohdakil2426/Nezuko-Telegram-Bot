-- =============================================================================
-- Nezuko InsForge Bootstrap (Current Canonical DB Setup)
-- Date: 2026-03-07
-- Purpose:
--   - Provision the full current database contract for Nezuko on a fresh InsForge project
--   - Collapse the migration chain into a single installer SQL for first-time setup
--   - Include the verification contract RPC and current join-request-first defaults
-- Scope:
--   - Database objects only: tables, indexes, views, functions, triggers, grants, RLS, policies
--   - Does NOT create storage buckets, edge functions, or auth provider settings
-- Notes:
--   - Intended for fresh installs or destructive resets
--   - Derived from 023_fresh_grammy_schema.sql plus current verification hardening
-- =============================================================================
...
CREATE TABLE public.protected_groups (
    ...
    params JSONB NOT NULL DEFAULT '{"join_request_preferred": true}'::JSONB,
