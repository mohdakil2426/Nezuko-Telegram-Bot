...
echo -e "     ${GRAY}- NEXT_PUBLIC_SUPABASE_URL${NC}"
echo -e "     ${GRAY}- NEXT_PUBLIC_SUPABASE_ANON_KEY${NC}"
echo ""
echo -e "  ${WHITE}📝 ${CYAN}apps/api/.env${NC}"
echo -e "     ${GRAY}- SUPABASE_URL, SUPABASE_ANON_KEY${NC}"
echo -e "     ${GRAY}- Set MOCK_AUTH=true for local dev${NC}"
echo ""
echo -e "  ${WHITE}📝 ${CYAN}apps/bot/.env${NC}"
echo -e "     ${GRAY}- BOT_TOKEN (from @BotFather)${NC}"
echo ""
