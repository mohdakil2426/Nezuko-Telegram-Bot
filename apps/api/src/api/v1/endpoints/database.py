...
from ...schemas.database import TableListResponse, TableDataResponse, MigrationStatusResponse
...
async def list_tables(
    session: AsyncSession = Depends(get_session), current_user=Depends(get_current_admin_user)
):
