...
// Floating Orbs Component - Hidden on mobile for performance
function FloatingOrbs() {
  return (
    <div className="absolute inset-0 overflow-hidden pointer-events-none hidden md:block">
      {/* Reduced sizes and blur for better performance */}
      <div className="absolute top-1/4 left-1/4 w-64 h-64 md:w-96 md:h-96 bg-primary/15 rounded-full blur-2xl md:blur-3xl animate-pulse" />
      <div
        className="absolute bottom-1/4 right-1/4 w-48 h-48 md:w-80 md:h-80 bg-primary/10 rounded-full blur-2xl md:blur-3xl animate-pulse"
        style={{ animationDelay: "1s" }}
      />
      <div
        className="absolute top-1/2 right-1/3 w-32 h-32 md:w-64 md:h-64 bg-primary/8 rounded-full blur-xl md:blur-3xl animate-pulse"
