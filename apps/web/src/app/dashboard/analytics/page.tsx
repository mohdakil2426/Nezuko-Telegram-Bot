...
export default function Analytics() {
  ...
  const filteredLogs =
    logFilter === "ALL"
      ? logs
      : logs.filter(
          (log) => log.level === logFilter || (logFilter === "INFO" && log.level === "DEBUG")
        );
  ...
  return (
    <div className="space-y-8">
      ...
      >
        ...
        />
        <MagneticButton variant="glass" onClick={handleExport} disabled={isExporting}>
          {isExporting ? (
            <m.div
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
                ...
                <defs>
                  <linearGradient id="purpleGrad" x1="0" y1="0" x2="0" y2="1">
                    <stop
                      ...
                      stopOpacity={resolvedTheme === "dark" ? 0.4 : 0.25}
                    />
                  ...
                  <linearGradient id="cyanGrad" x1="0" y1="0" x2="0" y2="1">
                    <stop
                      offset="0%"
                      stopColor="#ffffff"
                      stopOpacity={resolvedTheme === "dark" ? 0.3 : 0.2}
                    />
        ...
        {/* Command Usage */}
        <DashboardCard title="Command Usage" subtitle="Distribution by category" index={1}>
