...
async def test_verification_latency():
    ...
    assert p95 < TARGET_P95_LATENCY_MS, f"p95 latency {p95:.2f}ms exceeds {TARGET_P95_LATENCY_MS}ms target"
...
async def test_cache_hit_rate():
    ...
    print(f"  Verifications per user: 5")
...
async def test_protection_service_retry_logic():
    ...
    print(f"  Expected: ~3s (1s + 2s backoff)")
