...
def add_environment(logger: WrappedLogger, method_name: str, event_dict: EventDict) -> EventDict:
...
def extract_context(logger: WrappedLogger, method_name: str, event_dict: EventDict) -> EventDict:
    """
